 ...
 if ( !class_exists( 'Radium_Theme_Importer' ) ) {
	...
	class Radium_Theme_Importer {
	    ...
	    public function add_admin() {
	    	...
	    	add_theme_page('Import Demo Data', 'Import Demo Data', 'edit_theme_options', 'radium_demo_installer', array($this, 'demo_installer'));
	        //add_theme_page('themes.php', "Import Demo Data", "Import Demo Data", 'switch_themes', 'radium_demo_installer', );
        ...
        public function check_previous_meta( $continue, $post_id, $meta_key, $meta_value, $unique ) {
        	if( !empty( $_POST['_wp_http_referer'] ) && !stristr( $_POST['_wp_http_referer'], 'post.php' ) && !stristr( $_POST['_wp_http_referer'], 'post-new.php' ) ){
	    ...
	    public function set_demo_data( $file ) {
	        ...
	        if ( !class_exists( 'WP_Import' ) ) {
	            ...
	            $class_wp_import = get_template_directory() . '/includes/radium-one-click-demo-install/importer/wordpress-importer.php';
