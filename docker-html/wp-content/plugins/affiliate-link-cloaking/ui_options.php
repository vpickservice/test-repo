...
<div class="wrap">
    <h2><img src="<?php echo (get_bloginfo('url').'/wp-content/plugins/affiliate-link-cloaking/img/AffIcon_32.png'); ?>"  / > Affiliate link cloaking : Options <a href="<?php echo (admin_url('admin.php?page=affiliate-link-cloaking/affiliatelinkcloaking.php')); ?>" class="button add-new-h2">View All Links</a></h2>
</div>
