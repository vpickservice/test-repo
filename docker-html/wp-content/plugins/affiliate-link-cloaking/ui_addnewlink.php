...
<div class="wrap">
    <h2><img src="<?php echo (get_bloginfo('url').'/wp-content/plugins/affiliate-link-cloaking/img/AffIcon_32.png'); ?>"  / > Affiliate link cloaking : <?php global $g_uiaddnew; $g_uiaddnew->ShowSubmitButtonText(); ?> <a href="<?php echo (admin_url('admin.php?page=affiliate-link-cloaking/affiliatelinkcloaking.php')); ?>" class="button add-new-h2">View All Links</a></h2>
</div>
<p></p>
    ...
    <table class="form-table">
        <tbody>
             <tr>
                 ...
                 <td><?php bloginfo('url'); ?>/<input id="cloaklinkinput" name="cloaklinkinput" type="text" style="width:30%" value="<?php global $g_uiaddnew; $g_uiaddnew->ShowShortLink();  ?>" ></td>
             </tr>
             <tr>
